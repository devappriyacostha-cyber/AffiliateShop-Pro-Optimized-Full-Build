    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 lg:p-10">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 gap-2">
              {product.imageUrls.map((url, i) => (
                <div key={i} className="relative aspect-square bg-white border rounded cursor-pointer hover:border-orange-500 transition-all p-1">
          ...
          <div className="flex flex-col">
            ...
            <div className="space-y-4">
              <a
                ...
                className="w-full bg-orange-600 text-white text-center py-5 rounded-2xl font-black text-xl hover:bg-orange-500 transition-all shadow-xl shadow-orange-600/20 flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-[0.98]"
              >
                CHECK PRICE ON DARAZ <ExternalLink size={22} />
              </a>
        ...
        <div className="mt-16 border-t pt-10">
          ...
          <div className="prose max-w-none text-gray-700 leading-relaxed bg-gray-50/50 p-6 rounded-3xl border border-gray-100">
            {product.description}
            <br /><br />
          </div>
        </div>
